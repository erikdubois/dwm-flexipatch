...
static const char dwmdir[]               = "flexi";
...
static char titleselbgcolor[]            = "#3571f2";
...
static char tagsselbgcolor[]             = "#3571f2";
...
static const Key keys[] = {
	...
	#if SHIFTBOTH_PATCH
	{ MODKEY|ShiftMask,             XK_Tab,        shiftboth,              { .i = -1 } }, // note keybinding conflict with focusadjacenttag tagandviewtoleft placedir
	{ MODKEY, 			            XK_Tab,        shiftboth,              { .i = +1 } }, // note keybinding conflict with focusadjacenttag tagandviewtoright placedir
	{ Mod1Mask|ShiftMask,           XK_Tab,        shiftboth,              { .i = -1 } },
	{ Mod1Mask,			            XK_Tab,        shiftboth,              { .i = +1 } },
	...
	#if RESTARTSIG_PATCH
	{ ControlMask|Mod1Mask,			XK_Delete,     quit,                   {1} },
    ...
    { MODKEY|ControlMask,               XK_F7,       setlayout,      {.v = &layouts[12]} },
    { MODKEY|ControlMask,               XK_F8,       setlayout,      {.v = &layouts[13]} },
    { MODKEY|ControlMask,               XK_F9,       setlayout,      {.v = &layouts[14]} },
    { MODKEY|ControlMask,               XK_F10,      setlayout,      {.v = &layouts[15]} },
    { MODKEY|ControlMask,               XK_F11,      setlayout,      {.v = &layouts[16]} },
    { MODKEY|ControlMask,               XK_F12,      setlayout,      {.v = &layouts[17]} },
	...
	{ MODKEY|ControlMask,           XK_minus,      setscratch,             {.ui = 0 } },
	{ MODKEY|ShiftMask,             XK_minus,      removescratch,          {.ui = 0 } },
